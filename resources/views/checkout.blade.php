...
<section id="checkout" class="my-4">
	<div class="container">
		<div>
			<div class="clearfix m-auto" style="width: 300px">
				<div style="width: 55px;" class="float-left">
					<img src="/favicon.png" alt="logo" class="img-thumbnail">
				</div>
				<div class="float-left p-3" style="width: calc(100% - 55px)">
