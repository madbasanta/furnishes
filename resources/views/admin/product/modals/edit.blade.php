<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form action="/products/{{ $product->id }}/update" class="d-block" id="product-add">
        <div class="row">
          <div class="col-md-6">
            <div class="field">
              <label for="name">Product Name</label>
              <input type="text" name="name" id="name" class="form-control form-control-sm"
              placeholder="e.g. Shofa" value="{{ $product->name }}">
          ...
          <div class="col-md-6">
            <div class="field">
              ...
              <div class="input-group">
                ...
                placeholder="00.00" value="{{ number_format($product->price, 2, '.', '') }}">
              </div>
          ...
          <div class="col-md-6">
            <div class="field">
              ...
              data-v="{{ $product->category?$product->category->name:"" }}">
